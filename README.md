...
The core elicitation prompt sets used for the main evaluations are in
[`evals/`](evals/) — impossible numeric puzzles, trigger scenarios, tone
variations, the extended 8-turn conversation, and the frustration judge
rubric. See [`evals/README.md`](evals/README.md) for the multi-turn protocol.
